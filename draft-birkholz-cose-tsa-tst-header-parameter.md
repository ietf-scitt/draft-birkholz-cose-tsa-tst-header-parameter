...
Given that time-stamp tokens in this context are similar to a countersignature, the header parameter can is included in the unprotected header of a COSE envelope.
